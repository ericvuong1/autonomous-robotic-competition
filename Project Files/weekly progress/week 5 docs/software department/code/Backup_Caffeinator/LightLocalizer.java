...
public class LightLocalizer {
	...
	private final double startingPosition = -2;
	private final double startingAngle = 45;

	private final double lsToCenter = 12.5; // light sensor to center of robot
										// distance
	...
	public void doLocalization() {
		...
		double dTheta = (lineAngle[0] + lineAngle[2]) / 2 - 180;
