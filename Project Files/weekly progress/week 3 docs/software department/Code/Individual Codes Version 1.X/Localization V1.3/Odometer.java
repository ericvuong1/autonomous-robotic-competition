...
public class Odometer extends Thread {
	...
	public double deltatheta, distanceLeft, distanceRight, arclength;
	// tachometer readings
	private double tachoLeft = 0.0, tachoRight = 0.0;
	// odometer update period, in ms
	private static final long ODOMETER_PERIOD = 25;
	// robot physical specifications
	public static final double wheelRadius = 2.1;
	public static final double wheelDistance = 15;
	...
	public void run() {
		...
		while (true) {
			...
			double leftTacho = Math.toRadians(Motor.C.getTachoCount()); // Motor.B
																		// =
																		// leftWheel
			...
			double dLeftTacho = leftTacho - tachoLeft;
			double dRightTacho = rightTacho - tachoRight;
