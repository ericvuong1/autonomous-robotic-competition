...
public class Odometer extends Thread {
	...
	private static final double wheelDistance = 15;
	...
	public void run() {
		...
		while (true) {
			...
			//display usReading
			LCD.drawString("D = " + UltrasonicPoller.data, 0, 4);
			// put (some of) your odometer code here

			// compute tachometer reading into radians
			double leftTacho = Math.toRadians(Motor.A.getTachoCount()); // Motor.B
																		// =
																		// leftWheel
			double rightTacho = Math.toRadians(Motor.C.getTachoCount());// Motor.A
																		// =
																		// rightWheel
